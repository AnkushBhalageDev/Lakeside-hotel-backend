...
public class BookingController {
	...
	public ResponseEntity<?> getBookByConfirmationCode(@PathVariable String confirmationCode) {
		try {
	...
	public ResponseEntity<?> saveBooking(@PathVariable Long roomId, @RequestBody BookedRoom bookingRequest) {
		...
		} catch (InvalidBookngRequestException e) {
	...
	private BookingResponse getBookingResponse(BookedRoom booking) {
		...
		return new BookingResponse(booking.getBookingId(), booking.getCheckInDate(), booking.getCheckOutDate(),
				booking.getGuestFullName(), booking.getGuestEmail(), booking.getNoOfAdults(), booking.getNoOfChildren(),
				booking.getTotalNoOfGuest(), booking.getBookingConfirmationCode(), room);
	}
}
